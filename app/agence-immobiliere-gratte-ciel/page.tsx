  ...
  return (
    <>
      <JsonLd
        data={webPageLd({
          path: "/agence-immobiliere-gratte-ciel",
          name: "Agence immobilière Gratte-Ciel (Villeurbanne)",
          description:
            "Prix au m² réels du quartier Gratte-Ciel, calculés sur les ventes enregistrées.",
          dateModified: lastmodOf("/agence-immobiliere-gratte-ciel"),
        })}
      />
      <JsonLd
        data={serviceLd({
